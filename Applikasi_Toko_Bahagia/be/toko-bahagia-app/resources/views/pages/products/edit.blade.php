...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-dark">Edit Product {{ $product->id }}</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <div class="image-input image-input-outline image-input-placeholder mb-3"
                                    ...
                                    <label
                                        ...
                                        data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change Image Product">
                                        <!--begin::Icon-->
                                    ...
                                    <span
                                        class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                                        data-kt-image-input-action="cancel" data-bs-toggle="tooltip" title="Cancel Change Image">
                                    ...
                                    <span
                                        class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                                        data-kt-image-input-action="remove" data-bs-toggle="tooltip" title="Remove Image Product">
                                        <i class="bi bi-x fs-2"></i>
                                    </span>
                                    <!--end::Remove-->
                                </div>
