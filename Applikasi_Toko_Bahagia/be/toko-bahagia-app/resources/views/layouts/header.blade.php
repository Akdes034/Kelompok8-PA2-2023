...
<div id="kt_header" style="" class="header align-items-stretch" >
    ...
    <div class="header-brand" style="background-color: #2E3840">
        <!--begin::Logo-->

        <a href="{{ route('dashboard') }}" class="logo">
            <img alt="Logo" src="{{ asset('assets/media/logos/Toko Bahagia.png') }}" class="h-50px h-lg-75px" />
        </a>
        <!--end::Logo-->
        ...
        <div id="kt_aside_toggle" class="btn btn-icon w-auto px-0 btn-active-color-primary aside-minimize"
            ...
            <div style="background-color: #2C3333">
